...
namespace CefSharp.MinimalExample.WinForms
{
    public static class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            //Enables WebRTC
            // - CEF Doesn't currently support permissions on a per browser basis see https://bitbucket.org/`embedded/cef/issues/2582/allow-run-time-handling-of-media-access
